clear all
clc
bg = {imread("0_700x700.png"), imread("1.bmp"), imread("2.bmp"), imread("3.bmp")};
% Parâmetros comuns
...
plot_graphs('Bessel-Gaussian Beams', @bessel_gauss_phase_mask, modes, E0, h, delta, x, y, N, bg);
...
function plot_graphs(title_text, Phase_func, modes, E0, h, delta, x, y, N, expri)
    ...
    for idx = 1:num_modes
        ...
        Phase = Phase_func([N, N], mode, 'scale', 7);
